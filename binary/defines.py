...
from binary import protobuf_pb2
...
class WAWebMessageInfo:
    @staticmethod
    def decode(data):
        msg = protobuf_pb2.WebMessageInfo()
        msg.ParseFromString(data)
        return json.loads(json_format.MessageToJson(msg))

    @staticmethod
    def encode(msg):
        data = json_format.Parse(json.dumps(msg), protobuf_pb2.WebMessageInfo(), ignore_unknown_fields=True)
